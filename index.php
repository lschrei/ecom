...
$address = 'http://localhost:8888/ecom/'; //pour les liens qui menent à une autre page
$homeDirectory = 'http://localhost:8888/ecom/'; //pour les fichiers qu'on chargent depuis cette page
...
require_once 'application/bdd-login.php';
