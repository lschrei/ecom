...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Funup Décorations et cadeaux
            ...
            <div class="navbar-custom">
                ...
                <ul class="list-unstyled menu-left mb-0">
                    ...
                    <li class="app-search d-none d-md-block">
                        <form>
                            <input type="text" name="Titre" placeholder="" class="form-control">
                            <button type="submit" name="ajouter" class="sr-only"></button>
                        </form>
                    </li>
                </ul>
            </div>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Funup</a></li>
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Forms</a></li>
                                            <li class="breadcrumb-item active">Ajouter admin</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Ajouter admin</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
                            ...
                            <div class="col-md-12">
                                    ...
                                    <form method="POST" class="form-horizontal">
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label" for="simpleinput">User puis password</label>
                                   
                                            
                                            <div class="col-sm-10">
                                                <input type="text" name='user' class="form-control" id="simpleinput" value="">
                                                <br>
                                                <input type="text" name='password' class="form-control" id="simpleinput" value="">
                                                <br>
